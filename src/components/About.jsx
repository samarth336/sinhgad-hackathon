...
export default function AboutUs() {
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-7xl bg-gradient-to-r to-gray-900 text-white">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        {/* Left Section - Text Content */}
        <div className="space-y-6">
          <h1 className="text-4xl font-bold tracking-tight border-b-2 border-white pb-2 inline-block">
            ABOUT US - DIGIPROTECTOR & FACTSHIELD
          </h1>
          <div className="space-y-6">
            <p className="text-lg">
              <span className="font-semibold text-white">At DigiProtector,</span> we believe in the power of truth and transparency in the digital world. In today’s fast-paced, information-driven society, misinformation and fake news can spread rapidly, causing confusion and harm. That’s where FactShield comes in.
            </p>
            <p>
              <span className="font-semibold text-white">What is FactShield?</span> FactShield is an innovative platform designed to detect and flag fake news and misleading content on social media and other online platforms. By leveraging advanced AI and machine learning technologies, FactShield analyzes social media posts, news articles, images, and videos to identify false or manipulated information.
            </p>

            {showMore && (
              <>
                <p>
                  <span className="font-semibold text-white">Our goal</span> is to empower individuals, organizations, and media outlets with the tools they need to fight misinformation and ensure the integrity of the information they consume and share.
                </p>
                <p>
                  <span className="font-semibold text-white">How Does FactShield Work?</span> FactShield uses cutting-edge algorithms to:
                </p>
                ...
                <p>
                  <span className="font-semibold text-white">Why Choose FactShield?</span>
                </p>
                <ul className="list-disc pl-6">
                ...
                <p>
                  <span className="font-semibold text-white">Our Mission</span> We at DigiProtector are driven by the mission to combat the spread of fake news, promote digital literacy, and ensure a more informed online community. By using technology for good, we’re making the internet a safer place for everyone. With FactShield, we’re one step closer to a world where truth prevails over misinformation.
                </p>
              </>
            )}
          </div>
